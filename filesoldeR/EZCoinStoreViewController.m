...
    [items addObject:topup2];
    ...
    topup3.title           = NSLocalizedString(@"EZCoinStore.TopUp.Power", @"Power coin pack title");
    topup3.subtitle        = NSLocalizedString(@"EZCoinStore.TopUp.PowerSubtitle", @"Power coin pack description");
    topup3.priceString     = @"$49.99";
    topup3.planOrPackageID = @"TOPUP_6250";
    ...
    topup4.title           = NSLocalizedString(@"EZCoinStore.TopUp.Enterprise", @"Enterprise coin pack title");
    topup4.subtitle        = NSLocalizedString(@"EZCoinStore.TopUp.EnterpriseSubtitle", @"Enterprise coin pack description");
    topup4.priceString     = @"$99.99";
    topup4.planOrPackageID = @"TOPUP_12500";
    topup4.type            = EZStoreItemTypeTopUp;
    topup4.coins           = 12500;
    topup4.accentColor     = [UIColor systemPinkColor];
...
- (void)presentAnnualUpsellForMonthlyTier:(NSString *)monthlyTier token:(NSString *)token {
    ...
    NSDictionary *upsellConfig = @{
        kTierStandard: @{
            ...
            @"title":       NSLocalizedString(@"EZCoinStore.Upsell.StandardTitle", @"Standard annual upsell title"),
            @"monthlyBtn":  NSLocalizedString(@"EZCoinStore.Upsell.StandardMonthlyButton", @"$10.00/mo button"),
            @"annualBtn":   NSLocalizedString(@"EZCoinStore.Upsell.StandardAnnualButton", @"$89.99/yr, save $30 button"),
            @"annualBtnPromo": NSLocalizedString(@"EZCoinStore.Upsell.StandardAnnualButtonPromo", @"$89.99/yr, 2 more months free button"),
        },
        kTierPro: @{
            @"annualTier":  kTierProAnnual,
            @"title":       NSLocalizedString(@"EZCoinStore.Upsell.ProTitle", @"Pro annual upsell title"),
            @"monthlyBtn":  NSLocalizedString(@"EZCoinStore.Upsell.ProMonthlyButton", @"$15.00/mo button"),
            @"annualBtn":   NSLocalizedString(@"EZCoinStore.Upsell.ProAnnualButton", @"$134.99/yr, save $45 button"),
            @"annualBtnPromo": NSLocalizedString(@"EZCoinStore.Upsell.ProAnnualButtonPromo", @"$134.99/yr, 2 more months free button"),
        },
        kTierUltra: @{
            @"annualTier":  kTierUltraAnnual,
            @"title":       NSLocalizedString(@"EZCoinStore.Upsell.UltraTitle", @"Ultra annual upsell title"),
            @"monthlyBtn":  NSLocalizedString(@"EZCoinStore.Upsell.UltraMonthlyButton", @"$20.00/mo button"),
            @"annualBtn":   NSLocalizedString(@"EZCoinStore.Upsell.UltraAnnualButton", @"$179.99/yr, save $60 button"),
            @"annualBtnPromo": NSLocalizedString(@"EZCoinStore.Upsell.UltraAnnualButtonPromo", @"$179.99/yr, 2 more months free button"),
        },
        kTierPower: @{
            @"annualTier":  kTierPowerAnnual,
            @"title":       NSLocalizedString(@"EZCoinStore.Upsell.PowerTitle", @"Power annual upsell title"),
            @"monthlyBtn":  NSLocalizedString(@"EZCoinStore.Upsell.PowerMonthlyButton", @"$49.99/mo button"),
            @"annualBtn":   NSLocalizedString(@"EZCoinStore.Upsell.PowerAnnualButton", @"$449.99/yr, save $150 button"),
            @"annualBtnPromo": NSLocalizedString(@"EZCoinStore.Upsell.PowerAnnualButtonPromo", @"$449.99/yr, 2 more months free button"),
        },
        kTierEnterprise: @{
            @"annualTier":  kTierEnterpriseAnnual,
            @"title":       NSLocalizedString(@"EZCoinStore.Upsell.EnterpriseTitle", @"Enterprise annual upsell title"),
            @"monthlyBtn":  NSLocalizedString(@"EZCoinStore.Upsell.EnterpriseMonthlyButton", @"$99.99/mo button"),
            @"annualBtn":   NSLocalizedString(@"EZCoinStore.Upsell.EnterpriseAnnualButton", @"$899.99/yr, save $300 button"),
            @"annualBtnPromo": NSLocalizedString(@"EZCoinStore.Upsell.EnterpriseAnnualButtonPromo", @"$899.99/yr, 2 more months free button"),
        },
    };
    ...
    NSString *monthlyButtonText = config[@"monthlyBtn"];
    NSString *annualButtonText  = self.isPromoActive ? config[@"annualBtnPromo"] : config[@"annualBtn"];

    NSString *message = NSLocalizedString(@"EZCoinStore.Upsell.Message", @"Pay yearly and save 25% vs monthly message");

    UIAlertController *upsell = [UIAlertController
        alertControllerWithTitle:title
                          message:message
                   preferredStyle:UIAlertControllerStyleAlert];

    [upsell addAction:[UIAlertAction actionWithTitle:annualButtonText
    ...
    [upsell addAction:[UIAlertAction actionWithTitle:monthlyButtonText
                                                style:UIAlertActionStyleDefault
                                              handler:^(UIAlertAction *action) {
    ...
    [upsell addAction:[UIAlertAction actionWithTitle:NSLocalizedString(@"EZCoinStore.Cancel", @"Cancel button")
                                                style:UIAlertActionStyleCancel
                                              handler:nil]];
